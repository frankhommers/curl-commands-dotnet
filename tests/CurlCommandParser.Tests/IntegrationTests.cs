...
public class IntegrationTests
{
  ...
  {
    using HttpClient httpClient = new(new FakeHandler(request =>
    {
  ...
  {
    using HttpClient httpClient = new(new FakeHandler(async request =>
    {
  ...
  {
    using HttpClient httpClient = new(new FakeHandler(_ =>
  ...
  {
    using HttpClient httpClient = new(new FakeHandler(async _ =>
    {
    ...
    await Assert.ThrowsAnyAsync<OperationCanceledException>(
      () => httpClient.ExecuteCurlAsync("https://api.example.com/get", cts.Token));
  }
